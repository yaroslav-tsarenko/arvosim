        ...
        <AnimatedSection delay={0.2} className="space-y-6 lg:col-span-2">
          <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex gap-3"><MapPin className="mt-0.5 h-5 w-5 shrink-0 text-primary" /><div><p className="text-sm font-medium text-text">Address</p><p className="text-sm text-text-light">ELVORIN LTD<br />Registered address: Dept 6946, 196 High Road, Wood Green, London, N22 8HH, United Kingdom<br />Operational address: Suite 709, Avicenna House, 258–262 Romford Road, London, E7 9HZ, United Kingdom</p></div></div>
