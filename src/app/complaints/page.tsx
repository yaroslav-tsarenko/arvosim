...
const sections: PolicySection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        `the Account holder;`,
        `a person who completed or attempted a Balance Top-Up;`,
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        `the Order reference;`,
        `the Balance or payment reference;`,
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        `entitlement to Balance funds; or`,
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        `reserving disputed Balance funds;`,
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        `correct a Balance entry;`,
        `resend a QR code;`,
        `repair or reprovision an eSIM;`,
        `issue a replacement eSIM;`,
        `provide an equivalent Plan;`,
        `restore funds to the Balance;`,
        `refund an eligible Balance Top-Up;`,
  ...
  },
  {
    ...
    blocks: [
      `Where a financial remedy is approved, it will be handled in accordance with the Refund and Cancellation Policy and Payment and Balance Policy.`,
      `In particular:`,
      [
        `an approved voluntary eSIM refund will normally be restored to the Balance;`,
        `a qualifying Balance Top-Up refund will normally be returned to the original payment method;`,
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        `restore the Plan price to the Balance.`,
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        `suspend the disputed Balance funds;`,
      ...
      [
        ...
        `the corresponding Balance credit or purchased benefit.`,
      ],
    ],
  },
  {
    ...
    blocks: [
      `If your Account, eSIM, Order or Balance has been restricted, you may request a review.`,
  ...
  },
  {
    ...
    blocks: [
      ...
      `Before closing an Account, we may need to complete verification, settle pending Orders, resolve disputes and identify the source of Balance funds.`,
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      `The ICO can consider data protection matters. It does not resolve ordinary eSIM quality, Balance or contractual disputes that do not involve personal data.`,
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      `Complaints, reconsideration requests and dispute-related correspondence may be directed to ELVORIN LTD, company number 17344051, Suite 709, Avicenna House, 258–262 Romford Road, London, E7 9HZ, United Kingdom.`,
